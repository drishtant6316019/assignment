...
consumer_key011='vwdqsgjcvjabsncvvnmsxvs99'
consumer_secrete011='xshfxhg99lhfsbsvffgswgf1hdsghfgkhufteeryyi99'
access_token011='dsnxjwsdghjknbvffrddhjjjkjgdddghjjfg1'
access_token_secret011='bswhvwhvdwhsvhjwdsc33'
...
consumer_secrete011=''
access_token011=''
access_token_secret011=''
auth=tweepy.OAuthHandler(consumer_key011,consumer_secrete011)
auth.set_access_token(access_token35,access_token_secret35)
api=tweepy.API(auth)
tweets=api.search("#nevergiveupinyourlife",lang="en",count="5",tweet_mode="extended")
