...
# db=py.connect("localhost","root","123","library")
# cursor=db.cursor()
# cursor.execute("insert into book values(001,'looking for killer','india','fiction')")
# cursor.execute("insert into titles values(001,'looking for killer','1010',110,2020)")
# cursor.execute("insert into publisher values(001,'ABC','USA',10002,11001)")
# cursor.execute("insert into zip_code values(001,'ambala city','haryana',134003)")
# cursor.execute("insert into auth_title values(001,10010,1012012)")
# cursor.execute("insert into author values(001,'dik','null','green')")
