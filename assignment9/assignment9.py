...
class Circle:
	...
	def getArea(self):
       		 X = 3.14 * self.radius * self.radius
        print("Area of Circle is: ",X)
   
	def getCircumference(self):
       		 X = self.radius * 4 * 3.14
...
class temperature:
    ...
    def convertfahrenheit(self):
        fahrenheit = (celsius * 3.4) + 41
        print(fahrenheit)

    def convertcelcius(self):
        celsius = (fahrenheit - 41) / 3.4
        print(celsius)
...
class MovieDetails:
    ...
    def display(self):
 	...
 	print("Movie: ", self.moviename)
        ...
        print("ratings out of 4: ", self.ratings)
	...
	self.moviename = input("enter the new updated movie:")
        ...
        self.ratings = (input("enter the rating out of 4:"))
...
a1=Expenditure(expenditure,savings)
a1.display()
a1.totalsalary()
